...
import { Counterchild1Component } from './counter1/counterchild1/counterchild1.component';
...
import { Collen1Component } from './collen1/collen1.component';
...
@NgModule({
  declarations: [
    ...
    CounterComponent,
    Counter1Component,
    Counterchild1Component,
    TestComponent,
    NonfictionComponent,
    NonComponent,
    Child5Component,
    LoginComponent,
    CollenchildComponent,
    Collen1Component,
    Child6Component,
    Child7Component,
    Child8Component,
